(() => {
    ...
    (() => {
        ...
        let headerClubs = document.querySelector(".header__clubs");
        let clubsMenu = document.querySelector(".header__clubs-map");
        let headerWrapper = document.querySelector(".header__wrapper");
        if (headerClubs) {
            headerClubs.addEventListener("click", (function(e) {
                bodyLockToggle();
                headerClubs.classList.toggle("_active");
                clubsMenu.classList.toggle("_active");
                headerWrapper.classList.toggle("_active");
            }));
            let headerClub = document.querySelector(".header__clubs");
            let clubsMenus = document.querySelector(".header__clubs-map");
            let headerWrappers = document.querySelector(".header__wrapper");
            let headerBody = document.querySelector(".header__clubs-body");
            document.addEventListener("click", (e => {
                const withinBoundaries = e.composedPath().includes(headerBody);
                if (!withinBoundaries) {
                    headerClub.classList.remove("_active");
                    clubsMenus.classList.remove("_active");
                    headerWrappers.classList.remove("_active");
                }
            }));
        }
        function showMore() {
        ...
        class SelectConstructor {
            ...
            getOption(selectOption, originalSelect) {
                ...
                selectOptionHTML += selectOptionLink ? `<button ${selectOptionLinkTarget} ${selectOptionHide} href="${selectOptionLink}" data-value="${selectOption.value}" class="${this.selectClasses.classSelectOption}${selectOptionClass}${selectOptionSelected}">` : `<a ${selectOptionHide} class="${this.selectClasses.classSelectOption}${selectOptionClass}${selectOptionSelected}" data-value="${selectOption.value}" type="button">`;
        ...
        function initSliders() {
            if (document.querySelector(".members__slider")) new core(".members__slider", {
                ...
                navigation: {
                    prevEl: ".members__swiper-button-prev",
                    nextEl: ".members__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".girls__slider")) new core(".girls__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                loop: true,
                pagination: {
                    el: ".girls__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".girls__swiper-button-prev",
                    nextEl: ".girls__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".ticket__slider")) new core(".ticket__slider", {
                observer: true,
                observeParents: true,
                spaceBetween: 30,
                autoHeight: true,
            ...
            if (document.querySelector(".coupons__slider")) new core(".coupons__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: true,
                pagination: {
                    el: ".coupons__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".coupons__swiper-button-prev",
                    nextEl: ".coupons__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".bar-description__slider")) new core(".bar-description__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: true,
                pagination: {
                    el: ".bar-description__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".bar-description__swiper-button-prev",
                    nextEl: ".bar-description__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".bar-best__slider")) new core(".bar-best__slider", {
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                spaceBetween: 30,
            ...
            if (document.querySelector(".bar-reviews__slider")) new core(".bar-reviews__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: true,
                pagination: {
                    el: ".bar-reviews__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".bar-reviews__swiper-button-prev",
                    nextEl: ".bar-reviews__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".gifts-give__slider")) new core(".gifts-give__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".gifts-give__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".gifts-give__swiper-button-prev",
                    nextEl: ".gifts-give__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".gifts-give__slider-01")) new core(".gifts-give__slider-01", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".gifts-privileges__slider")) new core(".gifts-privileges__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".gifts-privileges__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".gifts-privileges__swiper-button-prev",
                    nextEl: ".gifts-privileges__swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".gifts-block__slider")) new core(".gifts-block__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 30,
                ...
                centeredSlides: true,
                pagination: {
                    el: ".gifts-block__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".gifts-block__swiper-button-prev",
                    nextEl: ".gifts-block__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 10,
            ...
            if (document.querySelector(".entertainment-offer__slider")) new core(".entertainment-offer__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".entertainment-offer__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".entertainment-offer__swiper-button-prev",
                    nextEl: ".entertainment-offer__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".entertainment-crazy__slider")) new core(".entertainment-crazy__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                pagination: {
                    el: ".entertainment-crazy__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".entertainment-crazy__swiper-button-prev",
                    nextEl: ".entertainment-crazy__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".poster__slider")) new core(".poster__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".poster__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".poster__swiper-button-prev",
                    nextEl: ".poster__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".entertainment-info__slider")) new core(".entertainment-info__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".entertainment-info__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".entertainment-info__swiper-button-prev",
                    nextEl: ".entertainment-info__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        const menuBlocks = document.querySelectorAll(".sub-menu__block");
        if (menuBlocks.length) menuBlocks.forEach((menuBlock => {
            ...
            menuBlock.classList.add(`sub-menu__block_${menuBlockItems}`);
        }));
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) {
                    ...
                    if (activeLink && activeLink !== targetElement) {
                        ...
                        activeLink.parentElement.classList.remove("_active");
                    }
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            const inputFile = document.querySelectorAll(".career-interview__file-input");
            inputFile.forEach((function(el) {
                let textSelector = document.querySelector(".career-interview__file-text");
                let fileList;
